...
class FakeTagService:
    ...
    def get_category_tree(self): return []
    def list_categories(self, parent_id=None): return []
    def rename_category(self, category_id, name): ...
    def move_category(self, category_id, new_parent_id): ...
    def delete_category(self, category_id): ...
    def add_tag_to_image(self, content_hash, tag_id): ...
    def remove_tag_from_image(self, content_hash, tag_id): ...
    def get_image_tags(self, content_hash): return []
    def add_image_to_category(self, content_hash, category_id): ...
    def remove_image_from_category(self, content_hash, category_id): ...
    def get_image_categories(self, content_hash): return []
...
class FakeRuntimeServices:
    def __init__(self) -> None:
        ...
        self.tag_service = FakeTagService()
        self.closed = 0
