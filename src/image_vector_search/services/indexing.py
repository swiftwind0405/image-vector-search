...
from image_vector_search.domain.models import ImagePathRecord, ImageRecord, IndexingReport
from image_vector_search.repositories.sqlite import MetadataRepository
from image_vector_search.scanning.files import iter_image_files, to_container_path
